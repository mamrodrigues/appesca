...
public class LoginUnescoActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
     ...
     */
    private static final String[] CREDENCIAIS_MOCK = new String[]{
            "luis.lima@unesco.org.br:123456:Luis Lima",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_unesco);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            for (String credential : CREDENCIAIS_MOCK) {
                ...
                if (pieces[0].equals(mEmail)) {
                    ...
                    if(pieces[1].equals(mPassword)){
                        ...
                        usuarioAutenticado.setNome(pieces[2]);
                        usuarioAutenticado.setEmail(pieces[0]);
